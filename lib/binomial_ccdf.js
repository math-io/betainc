...
*	Evaluates the complement of the cumulative distribution of a binomial distribution with
*	parameters `n` and `p = x`.
*
* @param {Number} n - number of trials of binomial distribution
* @param {Number} k - function input
* @param {Number} x - probability of success of binomial distribution
